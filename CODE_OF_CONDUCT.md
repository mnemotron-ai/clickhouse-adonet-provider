...
private report against this repository: use GitHub's "Report content" flow,
or, for anything overlapping a security concern, the private vulnerability
reporting form described in [SECURITY.md](SECURITY.md) (repository Security
tab → "Report a vulnerability"). Do not email maintainers personally and do
not open a public issue. All complaints will be reviewed and investigated
promptly and fairly.
